...
namespace CodeKurs.Web.Migrations
{
    ...
    [Migration("20260315182327_AddGeminiCliCourse")]
    partial class AddGeminiCliCourse
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CodeKurs.Web.Models.Lesson", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 156,
                            Description = "<p>Lifecycle und Sub-Agenten für komplexe Aufgaben.</p><p>In dieser Lektion lernst du fortgeschrittene Workflows und den Einsatz von Sub-Agenten kennen.</p>\n",
                            Language = "geminicli",
                            Order = 3,
                        ...
                        {
                            Id = 157,
                            Description = "<p>Ein Einstieg in die Welt der Gemini CLI und Agenten-Architektur.</p><p>In dieser Lektion lernst du die Grundlagen der Gemini CLI kennen.</p>\n",
                            Language = "geminicli",
                            Order = 1,
                        ...
                        {
                            Id = 158,
                            Description = "<p>Effizientes Arbeiten mit dem Dateisystem durch chirurgische Edits.</p><p>In dieser Lektion erfährst du, wie du effizient mit dem Dateisystem arbeitest.</p>\n",
                            Language = "geminicli",
                            Order = 2,
            ...
            modelBuilder.Entity("CodeKurs.Web.Models.ProgrammingTask", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ExpectedOutput = "",
                            InitialCode = "// In einem Controller mit _context\nvar users = _context.Users\n    .______(u => u.Name.StartsWith(\"A\"))\n    .ToList();\n",
                            Language = "aspnetcore",
                            LessonId = 111,
                            Order = 3,
                            RequiredKeywords = "Where",
                            Solution = "// In einem Controller mit _context\nvar users = _context.Users\n    .Where(u => u.Name.StartsWith(\"A\"))\n    .ToList();\n",
                        ...
                        new
                        {
                            ...
                            ExpectedOutput = "",
                            InitialCode = "@GetMapping(value = \"/user\", produces = MediaType._________________VALUE)\npublic User getUser() {\n    return new User(\"Tom\");\n}\n",
                            Language = "springboot",
                            LessonId = 129,
                            Order = 3,
                            RequiredKeywords = "APPLICATION_JSON_VALUE",
                            Solution = "@GetMapping(value = \"/user\", produces = MediaType.APPLICATION_JSON_VALUE)\npublic User getUser() {\n    return new User(\"Tom\");\n}\n",
                        ...
                        new
                        {
                            ...
                            ExpectedOutput = "",
                            InitialCode = "import org.springframework.data.jpa.repository.JpaRepository;\n\npublic interface UserRepository extends _____________<User, ____> {\n}\n",
                            Language = "springboot",
                            LessonId = 130,
                            Order = 2,
                        ...
                        new
                        {
                            ...
                            ExpectedOutput = "",
                            InitialCode = "public interface UserRepository extends JpaRepository<User, Long> {\n    User find_________________(String email);\n}\n",
                            Language = "springboot",
                            LessonId = 130,
                            Order = 3,
                        ...
                        new
                        {
                            ...
                            ExpectedOutput = "",
                            InitialCode = "@SpringBootApplication(exclude = {DataSourceAutoConfiguration._______})\npublic class MyBackend { }\n",
                            Language = "springboot",
                            LessonId = 131,
                            Order = 3,
                            RequiredKeywords = "class",
                            Solution = "@SpringBootApplication(exclude = {DataSourceAutoConfiguration.class})\npublic class MyBackend { }\n",
                        ...
                        new
                        {
                            ...
                            ExpectedOutput = "",
                            InitialCode = "import org.springframework.retry.annotation.Retryable;\n\n@__________ (retryFor = { RuntimeException._____ })\npublic void callExternalService() {\n    // Fehleranfälliger Aufruf\n}\n",
                            Language = "springboot",
                            LessonId = 132,
                            Order = 2,
                            RequiredKeywords = "Retryable,class",
                            Solution = "import org.springframework.retry.annotation.Retryable;\n\n@Retryable (retryFor = { RuntimeException.class })\npublic void callExternalService() {\n    // Fehleranfälliger Aufruf\n}\n",
                        ...
                        new
                        {
                            ...
                            InitialCode = "# Lese den Namen ein\nname = input()\nprint(\"Hallo \" + name)\n",
                            Language = "python",
                            LessonId = 149,
                            Order = 2,
                        ...
                        new
                        {
                            ...
                            ExpectedOutput = "20",
                            InitialCode = "# Lücke: zahl = ___(input())\nzahl = ___(input())\nprint(zahl * 2)\n",
                            Language = "python",
                            LessonId = 149,
                            Order = 3,
                            RequiredKeywords = "int",
                            Solution = "zahl = int(input())\nprint(zahl * 2)\n",
