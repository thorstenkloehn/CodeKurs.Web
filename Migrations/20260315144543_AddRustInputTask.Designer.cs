...
namespace CodeKurs.Web.Migrations
{
    ...
    [Migration("20260315144543_AddRustInputTask")]
    partial class AddRustInputTask
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CodeKurs.Web.Models.ProgrammingTask", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1011,
                            Description = "Lies einen Namen von der Konsole ein und gib 'Hallo [Name]!' aus. Hinweis: Nutze `std::io::stdin().read_line(&mut variable)`.",
