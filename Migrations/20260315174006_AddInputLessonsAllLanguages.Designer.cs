...
namespace CodeKurs.Web.Migrations
{
    ...
    [Migration("20260315174006_AddInputLessonsAllLanguages")]
    partial class AddInputLessonsAllLanguages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CodeKurs.Web.Models.Lesson", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 134,
                            Description = "<p>Lerne, wie du Daten in PHP von STDIN einliest.</p><p>In PHP nutzt du oft die vordefinierte Konstante <strong><code>STDIN</code></strong> für Eingaben.</p>\n<ol>\n<li><strong><code>fgets(STDIN)</code></strong>: Liest eine Zeile von der Standard-Eingabe.</li>\n<li><strong><code>trim()</code></strong>: Wichtig, da die Eingabe meist das Zeichen für das Zeilenende (<code>\\n</code>) enthält.</li>\n</ol>\n",
                            Language = "php",
                            Order = 5,
                            Title = "PHP: Benutzereingaben"
                        },
                        new
                        {
                            Id = 135,
            ...
            modelBuilder.Entity("CodeKurs.Web.Models.ProgrammingTask", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1085,
                            Description = "Nutze `fgets(STDIN)`, um eine Eingabe zu erhalten.",
                            ExpectedOutput = "Du hast gesagt: PHP",
                            InitialCode = "<?php\n// Lese von der Standard-Eingabe\n$input = fgets(STDIN);\necho \"Du hast gesagt: \" . trim($input);\n",
                            Language = "php",
                            LessonId = 134,
                            Order = 1,
                            RequiredKeywords = "fgets,STDIN",
                            Solution = "<?php\n$input = fgets(STDIN);\necho \"Du hast gesagt: \" . trim($input);\n",
                            Title = "STDIN: Einlesen",
                            Type = 1
                        },
                        new
                        {
                            Id = 1086,
                            Description = "Eingaben enthalten oft einen Zeilenumbruch. Welche Funktion entfernt diesen?",
                            ExpectedOutput = "Text",
                            InitialCode = "<?php\n$s = \"Text\\n\";\n// Lücke: $s = ____($s);\n$s = ____($s);\necho $s;\n",
                            Language = "php",
                            LessonId = 134,
                            ...
                            Solution = "<?php\n$s = \"Text\\n\";\n$s = trim($s);\necho $s;\n",
                            Title = "Lückentext: trim Funktion",
                            Type = 1
                        },
                        new
                        {
